...
public class UploadController {
    ...
    public String image(@RequestParam("file") MultipartFile file){
        ...
        try {
            ...
            BufferedImage read1 = ImageIO.read(file.getInputStream());
            if (read1==null){
                return null;
            }
           String path1= System.currentTimeMillis()+filename;
           // file.transferTo(new File("D:/upload/"+path1));
            //return "http://image.leyou.com/"+path1;
